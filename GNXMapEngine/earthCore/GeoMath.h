...
EARTH_CORE_NAMESPACE_BEGIN
    ...
    public:
         ...
         */
        static double distance(const std::vector<Vector3d> &points, double radius = WGS_84_RADIUS_EQUATOR);
         ...
         */
        static double rhumbDistance(const std::vector<Vector3d> &points, double radius = WGS_84_RADIUS_EQUATOR);
         ...
         */
        static unsigned interesectLineWithSphere(const Vector3d& p0,
                                                 const Vector3d& p1,
                                                 double            radius,
                                                 Vector3d&       out_i0,
                                                 Vector3d&       out_i1);
         ...
         */
        static bool isPointVisible(const Vector3d& eye,
