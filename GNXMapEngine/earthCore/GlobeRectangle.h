...
public:
   ...
   */
  void setWest(double value) noexcept { this->mWest = value; }
   ...
   */
  void setSouth(double value) noexcept { this->mSouth = value; }
   ...
   */
  void setEast(double value) noexcept { this->mEast = value; }
  ...
  constexpr Cartographic getSoutheast() const noexcept {
    return Cartographic(this->mEast, this->mSouth);
  }
  ...
  constexpr Cartographic getNorthwest() const noexcept {
    return Cartographic(this->mWest, this->mNorth);
  }
  ...
  constexpr Cartographic getNortheast() const noexcept {
    return Cartographic(this->mEast, this->mNorth);
  }
